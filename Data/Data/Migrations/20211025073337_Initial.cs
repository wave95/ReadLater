    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBookmarkClicks", x => x.UID);
                    table.ForeignKey(
                        name: "FK_UserBookmarkClicks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserBookmarkClicks_Bookmark_BookmarkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookmarkClicks_BookmarkId",
                table: "UserBookmarkClicks",
                column: "BookmarkId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookmarkClicks_UserId",
                table: "UserBookmarkClicks",
                column: "UserId");
        }
